...
<form action="{{route('admin.posts.store')}}" method="post">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="type the post title" aria-describedby="titleHelper" value="{{old('title')}}">
    ...
    <div class="mb-4">
        ...
        <input type="text" name="cover_image" id="cover_image" class="form-control  @error('cover_image') is-invalid @enderror" placeholder="insert the link" aria-describedby="cover_imageHelper" value="{{old('cover_image')}}">
