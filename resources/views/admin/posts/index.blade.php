...
<div class="d-flex justify-content-between py-4">
        <h1 class="fw-bolder">All Posts</h1>
        <div><a href="{{route('admin.posts.create')}}" class="btn btn-dark text-white fw-bold">Add Post</a></div>
    </div>
            ...
            <thead class="thead-inverse">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <a class="btn btn-secondary text-white btn-sm" href="{{route('admin.posts.edit', $post->slug)}}">
                        ...
                        <button type="button" class="btn btn-danger text-white btn-sm" data-bs-toggle="modal" data-bs-target="#delete-post-{{$post->id}}">
